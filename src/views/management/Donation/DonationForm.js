          ...
          <div className="container">
              <div className="quickLinksWrap">
                  <form className="quickPayLinks" name="_xclick" action="https://www.paypal.com/us/cgi-bin/webscr" method="post">
                      ...
                      <button type="submit" className="customPayButton" name="submit" value="value" alt="Make payments with PayPal - it's fast, free and secure!">25 BDT</button>
                  </form>
                  <form className="quickPayLinks" name="_xclick" action="https://www.paypal.com/us/cgi-bin/webscr" method="post">
                      <input type="hidden" name="cmd" defaultValue="_xclick" />
                      <input type="hidden" name="business" defaultValue="kfnunley@gmail.com" />
                      ...
                      <button type="submit" className="customPayButton" name="submit" value="value" alt="Make payments with PayPal - it's fast, free and secure!">50 BDT</button>
                  </form>
                  <form className="quickPayLinks" name="_xclick" action="https://www.paypal.com/us/cgi-bin/webscr" method="post">
                      <input type="hidden" name="cmd" defaultValue="_xclick" />
                      <input type="hidden" name="business" defaultValue="kfnunley@gmail.com" />
                      ...
                      <button type="submit" className="customPayButton" name="submit" value="value" alt="Make payments with PayPal - it's fast, free and secure!">75 BDT</button>
                  </form>
                  <form className="quickPayLinks" name="_xclick" action="https://www.paypal.com/us/cgi-bin/webscr" method="post">
                      <input type="hidden" name="cmd" defaultValue="_xclick" />
                      <input type="hidden" name="business" defaultValue="kfnunley@gmail.com" />
                      ...
                      <input type="hidden" name="item_name" defaultValue="Custom Design Service" />
                      <input type="hidden" name="amount" defaultValue="$25.00" />
                      <button type="submit" className="customPayButton" name="submit" value="value" alt="Make payments with PayPal - it's fast, free and secure!">100 BDT</button>
                  </form>
              </div>
              <h1> OR </h1>
              ...
              <form name="_xclick" action="https://www.paypal.com/us/cgi-bin/webscr" method="post">
                  ...
                  <input type="hidden" name="currency_code" defaultValue="USD" />
                  <input type="hidden" name="item_name" defaultValue="Custom Design Service" />
                  <input type="number" name="amount" defaultValue placeholder="0.00 BDT" />
