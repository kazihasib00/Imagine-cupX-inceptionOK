...
mock.onGet('/api/management/users').reply(200, {
  users: [
    {
...
mock.onGet('/api/management/users/1/emails').reply(200, {
  emails: [
    {
      id: uuidv4(),
...
mock.onGet('/api/management/users/1/invoices').reply(200, {
  invoices: [
    {
      id: uuidv4(),
      date: moment()
...
mock.onGet('/api/management/users/1/logs').reply(200, {
  logs: [
    {
      id: uuidv4(),
      status: 200,
